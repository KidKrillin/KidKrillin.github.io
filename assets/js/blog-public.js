...
async function renderBlogList() {
  ...
  listContainer.innerHTML = "Loading posts...";
  try {
    const postsRef = collection(db, "posts");
    const q = query(postsRef, where("published", "==", true), orderBy("createdAt", "desc"), limit(50));
    ...
    listContainer.textContent = "Failed to load posts.";
    console.error(e);
  }
}
